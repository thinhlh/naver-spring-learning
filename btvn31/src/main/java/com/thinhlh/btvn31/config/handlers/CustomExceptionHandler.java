...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<BaseResponse<Object>> handleDuplicatedResourceException(Exception e) {
        return ResponseEntity
