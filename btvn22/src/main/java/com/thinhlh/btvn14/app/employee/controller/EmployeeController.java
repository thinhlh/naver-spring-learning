package com.thinhlh.btvn14.app.employee.controller;
...
public class EmployeeController extends BaseController {
    ...
    @GetMapping("/employee/with-department-detail/{id}")
    private ResponseEntity<BaseResponse<EmployeeMybasticResponse>> getEmployeeByIdWithDepartmentDetail(@PathVariable("id") Long id) {
        return successResponse(employeeService.getEmployeeMybastic(id));
    }
